 ...
 *  RMIServer.java
 *
 *  This utility class May be used to register a Remote object using RMI
 *  that may be safely used within MPJ.
 *  See inner MPI_PROXY for MPI support
 *
...
public class RMIServer {
    ...
    public static class MPIProxy {  //threads waiting for requests to come and solve the problem
        private static ExecutorService executor;  //can use the service to request and receive, have some callable methods
        //callable can check the return value and check the key
        ...
        private static <T> T invoke(Callable<T> c) throws MPIException {
            try {
                ...
                return f.get();   //get the result of the future object
            }
        ...
        public void Sendrecv(final Object buf, final int offset, final int len, final Datatype stype, final int dest, final int stag, final Object rbuf, final int roffset, final int rlen, final Datatype rtype, final int src, final int rtag) throws MPIException {
